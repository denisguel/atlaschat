> **NOTA DE CURACIÓN:** Este documento reemplaza a la v1.0 de ARCH-003 (archivada). Las secciones de Execution Levels, BDVL, Cost Control y Context Builder se tratan aquí a nivel de síntesis arquitectónica; el detalle normativo vive en ARCH-0021, ARCH-0022, ARCH-0027 y ARCH-0029 respectivamente — este documento es el mapa, aquellos son el territorio.
